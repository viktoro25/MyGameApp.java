...
public class Wolf extends Animals {
    /**
     * Конструктор створення модель вовка.
     */
    public Wolf(){
        setName(IslandObjectTypes.Wolf);
        setSex(RandomEvent.getGenerationSex());
        setWeight(50);
        setMovementSpeed(3);
        setMaxNumberOfAnimalsPerCell(30);
        setWeightOfFoodConsumption(8);
    ...
    TreeMap<Object, Integer> creationTableInFoodAnimal() {
        ...
        tableInFoodAnimal.put(IslandObjectTypes.Horse, 10);
        tableInFoodAnimal.put(IslandObjectTypes.Deer, 15);
        tableInFoodAnimal.put(IslandObjectTypes.Rabbit, 60);
        tableInFoodAnimal.put(IslandObjectTypes.Mouse, 80);
        tableInFoodAnimal.put(IslandObjectTypes.Goat, 60);
        tableInFoodAnimal.put(IslandObjectTypes.Sheep, 70);
        tableInFoodAnimal.put(IslandObjectTypes.Boar, 15);
        tableInFoodAnimal.put(IslandObjectTypes.Buffalo, 10);
        tableInFoodAnimal.put(IslandObjectTypes.Duck, 40);
    ...
    public void initEntity() {
        linckEntity = getGameWorld().spawn("Wolf", getY(),getX());
    }
    ...
    protected void initPhysics() {
        getPhysicsWorld().addCollisionHandler(new CollisionHandler(IslandObjectTypes.Wolf, creationTableInFoodAnimal()) {

            // order of types is the same as passed into the constructor
            @Override
            protected void onCollisionBegin(Entity wolf, Entity creationTableInFoodAnimal) {
